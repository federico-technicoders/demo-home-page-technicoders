...
export default function Home() {
	...
	useGSAP(() => {
		...
		// esto hace que el scroll se mantenga en el mismo lugar en la sección 2
		ScrollTrigger.create({
			trigger: section2Current,
			start: "top top",
			endTrigger: section2Current,
		...
		// efecto de inicio del contenedor de la sección 2 - Y efecto de scroll al fin de la sección 2
		gsap.fromTo(contentSection2Current, 
			{
			  scale: 0.5,
			  borderRadius: "30px"
			},
