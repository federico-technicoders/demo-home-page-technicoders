...
export const CajaCuadrada = () => {
	...
	useGSAP(() => {
		...
		// 		markers: true,
		// 	},
		// 	// hacer que el contenedor ocupe el espacio de la sección 2b
		// 	height: "100vh",
		// 	width: "100vw",
		// 	// duration: 1,
		// 	ease: "power1.inOut",
		...
		// desaparece el div contenedor de la sección 2 cuando la sección 3 se desplaza
		gsap.to(contentSection2Current, {
			scrollTrigger: {
		...
		// desaparece el div contenedor de la sección 3 cuando la sección 4 se desplaza
        ...
        <div className="relative items-center justify-items-center min-h-screen pb-20 gap-16  font-[family-name:var(--font-geist-sans)]">
			<main className="flex flex-col justify-start items-start sm:items-start w-full">
				...
				>
					<div 
						ref={contentSection2}
						className='flex flex-col justify-center items-center w-[400px] h-[400px] bg-slate-200 scale-50 rounded-2xl'
					>
						<div 
							ref={tileSection2}
				...
				>
					<div 
						ref={contentSection3}
						className='flex flex-col justify-center items-center w-[400px] h-[400px] bg-slate-800 scale-50 rounded-2xl opacity-0'
					>
